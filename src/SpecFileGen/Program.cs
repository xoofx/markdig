...
namespace SpecFileGen
{
    class Program
    {
        ...
        static readonly Spec[] Specs = new[]
        {
            ...
            new Spec("Footnotes Labels",             "FootnotesLabelSpecs.md",           "footnotes-labels"),
            new Spec("Footnotes Labels No BackLink", "FootnotesLabelNoBackLinkSpecs.md", "footnotes-labels-nobacklink"),
